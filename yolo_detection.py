...
def detectObjects(image_object):
    ...
    npimg = np.fromstring(image_object, np.uint8)
    ...
    layerName = [layerName[i - 1] for i in net.getUnconnectedOutLayers()] #[i] -> i로 수정
    ...
    return outputs #output is dictionarys